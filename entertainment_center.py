import fresh_tomatoes #this file is used to generate a website that will take the data from the movies array and display them. It must be in the same folder as this current file
...
fresh_tomatoes.open_movies_page(movies) #takes in a list or an array of movies
